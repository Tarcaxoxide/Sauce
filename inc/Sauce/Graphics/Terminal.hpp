		...
		namespace Basic{
			class Terminal_cl{
				...
				public:
					...
					bool DrawTo(GOP_PixelStructure* OtherPixelBuffer,int64_t OtherPixelBufferTotalSize,int64_t OtherPixelsPerLine,Sauce::Point64_st Offset={0,0,0});
					bool DrawFrom(Terminal_cl* OtherTerminal);
