...
namespace Sauce{
	namespace Math{
		...
		//Graphical math
		Sauce::Graphics::Basic::Frame_st draw_line(Sauce::Point64_st startingPoint,Sauce::Point64_st endingPoint,GOP_PixelStructure foregroundColor={0xFF,0xFF,0xFF,0xFF},GOP_PixelStructure backgroundColor={0x00,0x00,0x00,0x00});
