...
namespace Sauce{
	namespace Math{
		...
		//#define MATH_CONSTANT_PI 3.14159265358979323846264338327950288419716939937510
		//#define MATH_CONSTANT_E 0.5772156649015328606065120900824024310421593359399
		//#define MATH_CONSTANT_ROOT2 1.4142135623730950488016887242096980785696718753769
		//#define MATH_CONSTANT_ROOT3 1.7320508075688772935274463415058723669428052538103
