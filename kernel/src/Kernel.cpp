...
namespace Sauce{
    ...
    void Kernel_cl::Prep_Windows(){
        Sauce::IO::Debug::Debugger_st Debugger("Kernel_cl::Prep_Windows",_NAMESPACE_,_ALLOW_PRINT_);
    ...
    void Kernel_cl::Prep_GDT(){
        Sauce::IO::Debug::Debugger_st Debugger("Kernel_cl::Prep_GDT",_NAMESPACE_,_ALLOW_PRINT_);
    ...
    void Kernel_cl::Add_Interrupt(void* Interrupt_Handler,uint8_t Interrupt_Number,uint8_t type_attr,uint8_t selector){
        Sauce::IO::Debug::Debugger_st Debugger("Kernel_cl::Add_Interrupt",_NAMESPACE_,_ALLOW_PRINT_);
    ...
    void Kernel_cl::Prep_Interrupts(){
        Sauce::IO::Debug::Debugger_st Debugger("Kernel_cl::Prep_Interrupts",_NAMESPACE_,_ALLOW_PRINT_);
        idtr.Limit = 0x0FFF;
    ...
    void Kernel_cl::Prep_IO(){
        Sauce::IO::Debug::Debugger_st Debugger("Kernel_cl::Prep_IO",_NAMESPACE_,_ALLOW_PRINT_);
        Sauce::Interrupts::RemapPic();
    }
    void Kernel_cl::Prep_ACPI(){
        Sauce::IO::Debug::Debugger_st Debugger("Kernel_cl::Prep_ACPI",_NAMESPACE_,_ALLOW_PRINT_);
    ...
    void Kernel_cl::oNotify_Of_KeyPress(Sauce::Keyboard_st xKeyboard){
        Sauce::IO::Debug::Debugger_st Debugger("Kernel_cl::oNotify_Of_KeyPress",_NAMESPACE_,_ALLOW_PRINT_);
        if(xKeyboard.Press){
    ...
    void Kernel_cl::DrawUI(){
        Sauce::IO::Debug::Debugger_st Debugger("Kernel_cl::DrawUI",_NAMESPACE_,_ALLOW_PRINT_);
        for(size_t i=0;i<Sauce::Global::Windows.Size();i++){
    ...
    void Kernel_cl::AcceptingInterrupts(size_t TimeSpan){
        Sauce::IO::Debug::Debugger_st Debugger("Kernel_cl::AcceptingInterrupts",_NAMESPACE_,_ALLOW_PRINT_);
        asm volatile("sti");
        Sauce::Interrupts::PIT::Sleep(TimeSpan);
        asm volatile("cli");
    }
    void Kernel_cl::Notify(Sauce::Interrupts::InterruptDataStruct InterruptData){
        Sauce::IO::Debug::Debugger_st Debugger("Kernel_cl::Notify",_NAMESPACE_,_ALLOW_PRINT_);
        asm volatile("cli");
