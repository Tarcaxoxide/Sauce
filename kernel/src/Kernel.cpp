...
namespace Sauce{
    ...
    void Kernel_cl::Prep_GlobalAllocator(){
        Sauce::IO::Debug::Debugger_st Debugger("Kernel_cl::Prep_GlobalAllocator",_NAMESPACE_);
    ...
    void Kernel_cl::Prep_VirtualAddresses(){
        Sauce::IO::Debug::Debugger_st Debugger("Kernel_cl::Prep_VirtualAddresses",_NAMESPACE_);
    ...
    void Kernel_cl::Prep_GDT(){
        Sauce::IO::Debug::Debugger_st Debugger("Kernel_cl::Prep_GDT",_NAMESPACE_);
    ...
    void Kernel_cl::Add_Interrupt(void* Interrupt_Handler,uint8_t Interrupt_Number,uint8_t type_attr,uint8_t selector){
        Sauce::IO::Debug::Debugger_st Debugger("Kernel_cl::Add_Interrupt",_NAMESPACE_);
    ...
    void Kernel_cl::Prep_Interrupts(){
        Sauce::IO::Debug::Debugger_st Debugger("Kernel_cl::Prep_Interrupts",_NAMESPACE_);
        idtr.Limit = 0x0FFF;
    ...
    void Kernel_cl::Prep_IO(){
        Sauce::IO::Debug::Debugger_st Debugger("Kernel_cl::Prep_IO",_NAMESPACE_);
        Sauce::Interrupts::RemapPic();
    }
    void Kernel_cl::Prep_ACPI(){
        Sauce::IO::Debug::Debugger_st Debugger("Kernel_cl::Prep_ACPI",_NAMESPACE_);
    ...
    void Kernel_cl::oNotify_Of_KeyPress(Sauce::Keyboard_st xKeyboard){
        Sauce::IO::Debug::Debugger_st Debugger("Kernel_cl::oNotify_Of_KeyPress",_NAMESPACE_);
        if(xKeyboard.Press){
    ...
    void Kernel_cl::oNotify_Of_Mouse(Sauce::Mouse_st* xMouse){
        Sauce::IO::Debug::Debugger_st Debugger("Kernel_cl::oNotify_Of_Mouse",_NAMESPACE_);
    ...
    void Kernel_cl::Notify(Sauce::Interrupts::InterruptDataStruct InterruptData){
        Sauce::IO::Debug::Debugger_st Debugger("Kernel_cl::Notify",_NAMESPACE_);
        asm volatile("cli");
