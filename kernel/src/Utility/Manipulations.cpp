	...
	namespace Utility{
        namespace Manipulate{
            size_t strlen(char* str){
                Sauce::IO::Debug::Debugger_st Debugger("strlen",_NAMESPACE_,_ALLOW_PRINT_);
                size_t size=0;
                char* strPtr=str;
                while(*(strPtr++) != '\0'){size++;}
                return size;
            ...
            bool strcmp(const char* strA,const char* strB){
                Sauce::IO::Debug::Debugger_st Debugger("strcmp",_NAMESPACE_,_ALLOW_PRINT_);
            ...
            Sauce::Memory::List_cl<_std::string> split(_std::string path, char delimiter){
                Sauce::IO::Debug::Debugger_st Debugger("split",_NAMESPACE_,_ALLOW_PRINT_);
            ...
            void swap_address(void** AddressA,void** AddressB){
                Sauce::IO::Debug::Debugger_st Debugger("swap_address",_NAMESPACE_,_ALLOW_PRINT_);
