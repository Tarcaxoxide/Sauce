...
namespace Sauce{
    namespace UserLand{
        ...
        void VirtualMachine_cl::AddFirst(TpCode TheType,uint64_t TheValue,uint64_t TheExtended){
            _VirtualStack_64_64.AddFirst({TheType,TheValue,TheExtended});
        }
        void VirtualMachine_cl::AddFirst(TpCode TheType,uint64_t TheValue,uint32_t TheExtended){
            _VirtualStack_64_32.AddFirst({TheType,TheValue,TheExtended});
        }
        void VirtualMachine_cl::AddFirst(TpCode TheType,uint64_t TheValue,uint16_t TheExtended){
            _VirtualStack_64_16.AddFirst({TheType,TheValue,TheExtended});
        }
        void VirtualMachine_cl::AddFirst(TpCode TheType,uint64_t TheValue,uint8_t TheExtended){
            _VirtualStack_64_08.AddFirst({TheType,TheValue,TheExtended});
        }
        void VirtualMachine_cl::AddFirst(TpCode TheType,uint32_t TheValue,uint64_t TheExtended){
            _VirtualStack_32_64.AddFirst({TheType,TheValue,TheExtended});
        }
        void VirtualMachine_cl::AddFirst(TpCode TheType,uint32_t TheValue,uint32_t TheExtended){
            _VirtualStack_32_32.AddFirst({TheType,TheValue,TheExtended});
        }
        void VirtualMachine_cl::AddFirst(TpCode TheType,uint32_t TheValue,uint16_t TheExtended){
            _VirtualStack_32_16.AddFirst({TheType,TheValue,TheExtended});
        }
        void VirtualMachine_cl::AddFirst(TpCode TheType,uint32_t TheValue,uint8_t TheExtended){
            _VirtualStack_32_08.AddFirst({TheType,TheValue,TheExtended});
        }
        void VirtualMachine_cl::AddFirst(TpCode TheType,uint16_t TheValue,uint64_t TheExtended){
            _VirtualStack_16_64.AddFirst({TheType,TheValue,TheExtended});
        }
        void VirtualMachine_cl::AddFirst(TpCode TheType,uint16_t TheValue,uint32_t TheExtended){
            _VirtualStack_16_32.AddFirst({TheType,TheValue,TheExtended});
        }
        void VirtualMachine_cl::AddFirst(TpCode TheType,uint16_t TheValue,uint16_t TheExtended){
            _VirtualStack_16_16.AddFirst({TheType,TheValue,TheExtended});
        }
        void VirtualMachine_cl::AddFirst(TpCode TheType,uint16_t TheValue,uint8_t TheExtended){
            _VirtualStack_16_08.AddFirst({TheType,TheValue,TheExtended});
        }
        void VirtualMachine_cl::AddFirst(TpCode TheType,uint8_t TheValue,uint64_t TheExtended){
            _VirtualStack_08_64.AddFirst({TheType,TheValue,TheExtended});
        }
        void VirtualMachine_cl::AddFirst(TpCode TheType,uint8_t TheValue,uint32_t TheExtended){
            _VirtualStack_08_32.AddFirst({TheType,TheValue,TheExtended});
        }
        void VirtualMachine_cl::AddFirst(TpCode TheType,uint8_t TheValue,uint16_t TheExtended){
            _VirtualStack_08_16.AddFirst({TheType,TheValue,TheExtended});
        }
        void VirtualMachine_cl::AddFirst(TpCode TheType,uint8_t TheValue,uint8_t TheExtended){
            _VirtualStack_08_08.AddFirst({TheType,TheValue,TheExtended});
        }
        void VirtualMachine_cl::AddLast(TpCode TheType,uint64_t TheValue,uint64_t TheExtended){
            _VirtualStack_64_64.AddLast({TheType,TheValue,TheExtended});
        }
        void VirtualMachine_cl::AddLast(TpCode TheType,uint64_t TheValue,uint32_t TheExtended){
            _VirtualStack_64_32.AddLast({TheType,TheValue,TheExtended});
        }
        void VirtualMachine_cl::AddLast(TpCode TheType,uint64_t TheValue,uint16_t TheExtended){
            _VirtualStack_64_16.AddLast({TheType,TheValue,TheExtended});
        }
        void VirtualMachine_cl::AddLast(TpCode TheType,uint64_t TheValue,uint8_t TheExtended){
            _VirtualStack_64_08.AddLast({TheType,TheValue,TheExtended});
        }
        void VirtualMachine_cl::AddLast(TpCode TheType,uint32_t TheValue,uint64_t TheExtended){
            _VirtualStack_32_64.AddLast({TheType,TheValue,TheExtended});
        }
        void VirtualMachine_cl::AddLast(TpCode TheType,uint32_t TheValue,uint32_t TheExtended){
            _VirtualStack_32_32.AddLast({TheType,TheValue,TheExtended});
        }
        void VirtualMachine_cl::AddLast(TpCode TheType,uint32_t TheValue,uint16_t TheExtended){
            _VirtualStack_32_16.AddLast({TheType,TheValue,TheExtended});
        }
        void VirtualMachine_cl::AddLast(TpCode TheType,uint32_t TheValue,uint8_t TheExtended){
            _VirtualStack_32_08.AddLast({TheType,TheValue,TheExtended});
        }
        void VirtualMachine_cl::AddLast(TpCode TheType,uint16_t TheValue,uint64_t TheExtended){
            _VirtualStack_16_64.AddLast({TheType,TheValue,TheExtended});
        }
        void VirtualMachine_cl::AddLast(TpCode TheType,uint16_t TheValue,uint32_t TheExtended){
            _VirtualStack_16_32.AddLast({TheType,TheValue,TheExtended});
        }
        void VirtualMachine_cl::AddLast(TpCode TheType,uint16_t TheValue,uint16_t TheExtended){
            _VirtualStack_16_16.AddLast({TheType,TheValue,TheExtended});
        }
        void VirtualMachine_cl::AddLast(TpCode TheType,uint16_t TheValue,uint8_t TheExtended){
            _VirtualStack_16_08.AddLast({TheType,TheValue,TheExtended});
        }
        void VirtualMachine_cl::AddLast(TpCode TheType,uint8_t TheValue,uint64_t TheExtended){
            _VirtualStack_08_64.AddLast({TheType,TheValue,TheExtended});
        }
        void VirtualMachine_cl::AddLast(TpCode TheType,uint8_t TheValue,uint32_t TheExtended){
            _VirtualStack_08_32.AddLast({TheType,TheValue,TheExtended});
        }
        void VirtualMachine_cl::AddLast(TpCode TheType,uint8_t TheValue,uint16_t TheExtended){
            _VirtualStack_08_16.AddLast({TheType,TheValue,TheExtended});
        }
        void VirtualMachine_cl::AddLast(TpCode TheType,uint8_t TheValue,uint8_t TheExtended){
            _VirtualStack_08_08.AddLast({TheType,TheValue,TheExtended});
        }
        void VirtualMachine_cl::GetFirst(TpCode &TheType,uint64_t &TheValue,uint64_t &TheExtended){
        ...
        void VirtualMachine_cl::GetFirst(TpCode &TheType,uint64_t &TheValue,uint32_t &TheExtended){
        ...
        void VirtualMachine_cl::GetFirst(TpCode &TheType,uint64_t &TheValue,uint16_t &TheExtended){
        ...
        void VirtualMachine_cl::GetFirst(TpCode &TheType,uint64_t &TheValue,uint8_t &TheExtended){
        ...
        void VirtualMachine_cl::GetFirst(TpCode &TheType,uint16_t &TheValue,uint64_t &TheExtended){
        ...
        void VirtualMachine_cl::GetFirst(TpCode &TheType,uint16_t &TheValue,uint32_t &TheExtended){
        ...
        void VirtualMachine_cl::GetFirst(TpCode &TheType,uint16_t &TheValue,uint16_t &TheExtended){
        ...
        void VirtualMachine_cl::GetFirst(TpCode &TheType,uint16_t &TheValue,uint8_t &TheExtended){
        ...
        void VirtualMachine_cl::GetFirst(TpCode &TheType,uint8_t &TheValue,uint64_t &TheExtended){
        ...
        void VirtualMachine_cl::GetFirst(TpCode &TheType,uint8_t &TheValue,uint32_t &TheExtended){
        ...
        void VirtualMachine_cl::GetFirst(TpCode &TheType,uint8_t &TheValue,uint16_t &TheExtended){
        ...
        void VirtualMachine_cl::GetFirst(TpCode &TheType,uint8_t &TheValue,uint8_t &TheExtended){
        ...
        void VirtualMachine_cl::GetLast(TpCode &TheType,uint64_t &TheValue,uint64_t &TheExtended){
        ...
        void VirtualMachine_cl::GetLast(TpCode &TheType,uint64_t &TheValue,uint32_t &TheExtended){
        ...
        void VirtualMachine_cl::GetLast(TpCode &TheType,uint64_t &TheValue,uint16_t &TheExtended){
        ...
        void VirtualMachine_cl::GetLast(TpCode &TheType,uint64_t &TheValue,uint8_t &TheExtended){
            TheType=_VirtualStack_64_08.First().Type;
            TheValue=_VirtualStack_64_08.First().Value;
            TheExtended=_VirtualStack_64_08.First().Extended;
        }
        void VirtualMachine_cl::GetLast(TpCode &TheType,uint16_t &TheValue,uint64_t &TheExtended){
        ...
        void VirtualMachine_cl::GetLast(TpCode &TheType,uint16_t &TheValue,uint32_t &TheExtended){
        ...
        void VirtualMachine_cl::GetLast(TpCode &TheType,uint16_t &TheValue,uint16_t &TheExtended){
        ...
        void VirtualMachine_cl::GetLast(TpCode &TheType,uint16_t &TheValue,uint8_t &TheExtended){
        ...
        void VirtualMachine_cl::GetLast(TpCode &TheType,uint8_t &TheValue,uint32_t &TheExtended){
        ...
        void VirtualMachine_cl::GetLast(TpCode &TheType,uint8_t &TheValue,uint16_t &TheExtended){
        ...
        void VirtualMachine_cl::GetLast(TpCode &TheType,uint8_t &TheValue,uint8_t &TheExtended){
        ...
        void VirtualMachine_cl::Clone(SzCode FromStack,SzCode ToStack){
            switch(FromStack){
                case SzCode::V64_E64:{
                    ...
                    switch(ToStack){
                        case SzCode::V64_E64:{
                            uint64_t TheNewValue=(uint64_t)TheValue;
            ...
            switch(aStack.Get_SzCode()){
                case SzCode::V64_E64:{
                    switch(bStack.Get_SzCode()){
                        case SzCode::V64_E64:{
                            aStack.V64()+=(uint64_t)bStack.V64();
                        }break;
                        case SzCode::V64_E32:{
                            aStack.V64()+=(uint64_t)bStack.V64();
                        }break;
                        ...
                        case SzCode::V32_E64:{
                            aStack.V64()+=(uint64_t)bStack.V32();
                        }break;
                        case SzCode::V32_E32:{
                            aStack.V64()+=(uint64_t)bStack.V32();
                        }break;
                        ...
                        case SzCode::V16_E64:{
                            aStack.V64()+=(uint64_t)bStack.V16();
                        }break;
                        case SzCode::V16_E32:{
                            aStack.V64()+=(uint64_t)bStack.V16();
                        }break;
                ...
                case SzCode::V32_E64:{
                    switch(bStack.Get_SzCode()){
                        case SzCode::V64_E64:{
                            aStack.V32()+=(uint32_t)bStack.V64();
                        }break;
                        case SzCode::V64_E32:{
                            aStack.V32()+=(uint32_t)bStack.V64();
                        }break;
                        ...
                        case SzCode::V32_E64:{
                            aStack.V32()+=(uint32_t)bStack.V32();
                        }break;
                        case SzCode::V32_E32:{
                            aStack.V32()+=(uint32_t)bStack.V32();
                        }break;
                        ...
                        case SzCode::V16_E64:{
                            aStack.V32()+=(uint32_t)bStack.V16();
                        }break;
                        case SzCode::V16_E32:{
                            aStack.V32()+=(uint32_t)bStack.V16();
                        }break;
                ...
                case SzCode::V16_E64:{
                    switch(bStack.Get_SzCode()){
                        case SzCode::V64_E64:{
                            aStack.V16()+=(uint16_t)bStack.V64();
                        }break;
                        case SzCode::V64_E32:{
                            aStack.V16()+=(uint16_t)bStack.V64();
                        }break;
                        ...
                        case SzCode::V32_E64:{
                            aStack.V16()+=(uint16_t)bStack.V32();
                        }break;
                        case SzCode::V32_E32:{
                            aStack.V16()+=(uint16_t)bStack.V32();
                        }break;
                        ...
                        case SzCode::V16_E64:{
                            aStack.V16()+=(uint16_t)bStack.V16();
                        }break;
                        case SzCode::V16_E32:{
                            aStack.V16()+=(uint16_t)bStack.V16();
                        }break;
            ...
            for(size_t InstructionCounter=0;InstructionCounter<code.Size();InstructionCounter++){
                ...
                switch(CurrentInstruction.Get_OpCode()){
                    ...
                    case OpCode::OP__ADD:{
                        ...
                        if(FromStack.Get_SzCode() >= ToStack.Get_SzCode()){
                            MathematicalAdd(FromStack,ToStack);
                            AddLast(FromStack);
                        }else{
                            MathematicalAdd(ToStack,FromStack);
                            AddLast(ToStack);
                        }
                    }break;
                    case OpCode::OP__SUBTRACT:{}break;
                    case OpCode::OP__MULTIPLY:{}break;
                    case OpCode::OP__DIVIDE:{}break;
                    case OpCode::OP__MODULUS:{}break;
                    case OpCode::OP__MORE_THAN:{}break;
                    case OpCode::OP__LESS_THAN:{}break;
                    case OpCode::OP__EQUALS:{}break;
