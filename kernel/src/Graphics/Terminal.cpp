...
namespace Sauce{
    namespace Graphics{
        ...
        bool Terminal_cl::SetColor(GOP_PixelStructure ForegroundColor,GOP_PixelStructure BackgroundColor){
            Sauce::IO::Debug::Debugger_st Debugger("Terminal_cl::SetColor",_NAMESPACE_,_ALLOW_PRINT_);
            this->ForegroundColor=ForegroundColor;
            this->BackgroundColor=BackgroundColor;
            return true;
        }
        void Terminal_cl::ReverseColor(){
            Sauce::IO::Debug::Debugger_st Debugger("Terminal_cl::ReverseColor",_NAMESPACE_,_ALLOW_PRINT_);
        ...
        bool Terminal_cl::RowFill(size_t RowIndex,GOP_PixelStructure TheColor){
            Sauce::IO::Debug::Debugger_st Debugger("Terminal_cl::RowFill",_NAMESPACE_,_ALLOW_PRINT_);
        ...
        bool Terminal_cl::PutPixel(Sauce::Point64_st Location,GOP_PixelStructure TheColor){
            Sauce::IO::Debug::Debugger_st Debugger("Terminal_cl::PutPixel",_NAMESPACE_,_ALLOW_PRINT_);
        ...
        bool Terminal_cl::RowClear(size_t RowIndex){
            Sauce::IO::Debug::Debugger_st Debugger("Terminal_cl::RowClear",_NAMESPACE_,_ALLOW_PRINT_);
            bool Ret=RowFill(RowIndex,BackgroundColor);
            return Ret;
        }
        bool Terminal_cl::ColumnClear(size_t ColumnIndex){
            Sauce::IO::Debug::Debugger_st Debugger("Terminal_cl::ColumnClear",_NAMESPACE_,_ALLOW_PRINT_);
            bool Ret = ColumnFill(ColumnIndex,BackgroundColor);
            return Ret;
        }
        bool Terminal_cl::Clear(){
            Sauce::IO::Debug::Debugger_st Debugger("Terminal_cl::Clear",_NAMESPACE_,_ALLOW_PRINT_);
        ...
        bool Terminal_cl::SetCursor(int64_t X,int64_t Y,int64_t Z){
            Sauce::IO::Debug::Debugger_st Debugger("Terminal_cl::SetCursor",_NAMESPACE_,_ALLOW_PRINT_);
            PixelPointer={X,Y,Z};
            return true;
        }
        bool Terminal_cl::CopyTo(GOP_PixelStructure* OtherPixelBuffer,size_t OtherPixelBufferTotalSize,size_t OtherPixelsPerLine,Sauce::Point64_st Offset){
            Sauce::IO::Debug::Debugger_st Debugger("Terminal_cl::CopyTo",_NAMESPACE_,_ALLOW_PRINT_);
            Offset.X+=MyOffset.X;
            Offset.Y+=MyOffset.Y;
            Offset.Z+=MyOffset.Z;
        ...
        bool Terminal_cl::Move(Sauce::Point64_st Offset){
            Sauce::IO::Debug::Debugger_st Debugger("Terminal_cl::Move",_NAMESPACE_,_ALLOW_PRINT_);
            MyOffset=Offset;
            return true;
        }
        ...
        void Terminal_cl::Notify_Of_Mouse_Left_Down(Sauce::Point64_st Location){
            Sauce::IO::Debug::Debugger_st Debugger("Terminal_cl::Notify_Of_Mouse_Left_Down",_NAMESPACE_,_ALLOW_PRINT_);
        ...
        void Terminal_cl::Notify_Of_Mouse_Right_Down(Sauce::Point64_st Location){
            Sauce::IO::Debug::Debugger_st Debugger("Terminal_cl::Notify_Of_Mouse_Right_Down",_NAMESPACE_,_ALLOW_PRINT_);
            if(Sauce::Global::Mouse->Is_Over(Location)){
                Debugger.Print("Click Detected");
            }
        }
        void Terminal_cl::Notify_Of_Mouse_Center_Down(Sauce::Point64_st Location){
            Sauce::IO::Debug::Debugger_st Debugger("Terminal_cl::Notify_Of_Mouse_Center_Down",_NAMESPACE_,_ALLOW_PRINT_);
            if(Sauce::Global::Mouse->Is_Over(Location)){
                Debugger.Print("Click Detected");
            }
        }
		void Terminal_cl::Notify_Of_Mouse_Left_Up(Sauce::Point64_st Location){
            Sauce::IO::Debug::Debugger_st Debugger("Terminal_cl::Notify_Of_Mouse_Left_Up",_NAMESPACE_,_ALLOW_PRINT_);
            if(Sauce::Global::Mouse->Is_Over(Location)){
                Debugger.Print("Release Detected");
            }
        }
		void Terminal_cl::Notify_Of_Mouse_Right_Up(Sauce::Point64_st Location){
            Sauce::IO::Debug::Debugger_st Debugger("Terminal_cl::Notify_Of_Mouse_Right_Up",_NAMESPACE_,_ALLOW_PRINT_);
            if(Sauce::Global::Mouse->Is_Over(Location)){
                Debugger.Print("Release Detected");
            }
        }
		void Terminal_cl::Notify_Of_Mouse_Center_Up(Sauce::Point64_st Location){
            Sauce::IO::Debug::Debugger_st Debugger("Terminal_cl::Notify_Of_Mouse_Center_Up",_NAMESPACE_,_ALLOW_PRINT_);
            if(Sauce::Global::Mouse->Is_Over(Location)){
                Debugger.Print("Release Detected");
            }
        }
        void Terminal_cl::Notify_Of_Mouse_Left_Drag(Sauce::Point64_st Location,Sauce::Point64_st OldLocation){
            Sauce::IO::Debug::Debugger_st Debugger("Terminal_cl::Notify_Of_Mouse_Left_Drag",_NAMESPACE_,_ALLOW_PRINT_);
            if(Sauce::Global::Mouse->Is_Over(Location)){
		...
		void Terminal_cl::Notify_Of_Mouse_Right_Drag(Sauce::Point64_st Location,Sauce::Point64_st OldLocation){
            Sauce::IO::Debug::Debugger_st Debugger("Terminal_cl::Notify_Of_Mouse_Right_Drag",_NAMESPACE_,_ALLOW_PRINT_);
            if(Sauce::Global::Mouse->Is_Over(Location)){
                Debugger.Print("Drag Detected");
            }
        }
		void Terminal_cl::Notify_Of_Mouse_Center_Drag(Sauce::Point64_st Location,Sauce::Point64_st OldLocation){
            Sauce::IO::Debug::Debugger_st Debugger("Terminal_cl::Notify_Of_Mouse_Center_Drag",_NAMESPACE_,_ALLOW_PRINT_);
            if(Sauce::Global::Mouse->Is_Over(Location)){
                Debugger.Print("Drag Detected");
            }
        }
        void Terminal_cl::Notify_Of_Keyboard_Press(Sauce::Keyboard_st KeyData){
            Sauce::IO::Debug::Debugger_st Debugger("Terminal_cl::Notify_Of_Keyboard_Press",_NAMESPACE_,_ALLOW_PRINT_);
        }
    };
};
