...
namespace Sauce{
    namespace Interrupts{
        __attribute__((interrupt)) void PageFault_handler(interrupt_frame* frame){
            if(Sauce::IO::Debug::FUNCTION_CALLS && Sauce::IO::Debug::INTERRUPTS && Sauce::IO::Debug::INTERRUPT_FAULTS)Sauce::IO::Debug::COM1_Console.Write((char*)"[PageFault_handler]\n\0");
            Sauce::IO::Panic("Page Fault Detected!\n\r\0");
        }
        __attribute__((interrupt)) void DoubleFault_handler(interrupt_frame* frame){
            if(Sauce::IO::Debug::FUNCTION_CALLS && Sauce::IO::Debug::INTERRUPTS && Sauce::IO::Debug::INTERRUPT_FAULTS)Sauce::IO::Debug::COM1_Console.Write((char*)"[DoubleFault_handler]\n\0");
            Sauce::IO::Panic("Double Fault Detected!\n\r\0");
        }
        __attribute__((interrupt)) void GeneralProtectionFault_handler(interrupt_frame* frame){
            if(Sauce::IO::Debug::FUNCTION_CALLS && Sauce::IO::Debug::INTERRUPTS && Sauce::IO::Debug::INTERRUPT_FAULTS)Sauce::IO::Debug::COM1_Console.Write((char*)"[GeneralProtectionFault_handler]\n\0");
