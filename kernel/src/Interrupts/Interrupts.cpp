...
namespace Sauce{
    namespace Interrupts{
        __attribute__((interrupt)) void PageFault_handler(interrupt_frame* frame){
            ...
            Debugger.Print(Sauce::Utility::HexToString((uint64_t)(*((uint64_t*)frame))));
        ...
        void PIC1_Done(){
            Sauce::IO::Debug::Debugger_st Debugger("PIC1_Done",_NAMESPACE_);
            Sauce::IO::outb(PIC1_COMMAND,PIC_EOI);
        }
        void PIC2_Done(){
            Sauce::IO::Debug::Debugger_st Debugger("PIC2_Done",_NAMESPACE_);
            Sauce::IO::outb(PIC2_COMMAND,PIC_EOI);
            Sauce::IO::outb(PIC1_COMMAND,PIC_EOI);
        }
        void RemapPic(){
            Sauce::IO::Debug::Debugger_st Debugger("RemapPic",_NAMESPACE_);
            uint8_t a1, a2;
