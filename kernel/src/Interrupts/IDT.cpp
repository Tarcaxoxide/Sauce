...
namespace Sauce{
    namespace Interrupts{
        void IDTDescriptorEntry::SetOffset(uint64_t offset){
            ...
            if(Sauce::IO::Debug::FUNCTION_CALLS && Sauce::IO::Debug::INTERRUPT_DESCRIPTOR_TABLE)Sauce::IO::Debug::COM1_Console.Write((char*)"\t<-(void)\n\0");
        }
        uint64_t IDTDescriptorEntry::GetOffset(){
            ...
            if(Sauce::IO::Debug::FUNCTION_CALLS && Sauce::IO::Debug::INTERRUPT_DESCRIPTOR_TABLE){
