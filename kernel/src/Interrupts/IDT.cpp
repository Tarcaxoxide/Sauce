...
namespace Sauce{
    namespace Interrupts{
        void IDTDescriptorEntry::SetOffset(uint64_t offset){
            Sauce::IO::Debug::Debugger_st Debugger("IDTDescriptorEntry::SetOffset",_NAMESPACE_,_ALLOW_PRINT_);
        ...
        uint64_t IDTDescriptorEntry::GetOffset(){
            Sauce::IO::Debug::Debugger_st Debugger("IDTDescriptorEntry::GetOffset",_NAMESPACE_,_ALLOW_PRINT_);
            uint64_t offset=0;
