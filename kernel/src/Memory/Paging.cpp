...
namespace Sauce{
    namespace Memory{
        void PageDirectoryEntry::SetFlag(Sauce::IO::Debug::Debugger_st* pDebugger,PT_Flag flag,bool enabled){
            Sauce::IO::Debug::Debugger_st Debugger(pDebugger,"PageDirectoryEntry::SetFlag",_NAMESPACE_);
            uint64_t bitSelector = (uint64_t)1<< flag;
            Value &= ~bitSelector;
            if(enabled)Value |= bitSelector;
        }
        bool PageDirectoryEntry::GetFlag(Sauce::IO::Debug::Debugger_st* pDebugger,PT_Flag flag){
            Sauce::IO::Debug::Debugger_st Debugger(pDebugger,"PageDirectoryEntry::GetFlag",_NAMESPACE_);
            uint64_t bitSelector = (uint64_t)1<< flag;
        ...
        void PageDirectoryEntry::SetAddress(Sauce::IO::Debug::Debugger_st* pDebugger,uint64_t address){
            Sauce::IO::Debug::Debugger_st Debugger(pDebugger,"PageDirectoryEntry::SetAddress",_NAMESPACE_);
            address &= 0x000000ffffffffff;
            Value &= 0xfff0000000000fff;
            Value |= (address << 12);
        }
        uint64_t PageDirectoryEntry::GetAddress(Sauce::IO::Debug::Debugger_st* pDebugger){
            Sauce::IO::Debug::Debugger_st Debugger(pDebugger,"PageDirectoryEntry::GetAddress",_NAMESPACE_);
