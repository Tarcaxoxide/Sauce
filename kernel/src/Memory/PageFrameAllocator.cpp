...
namespace Sauce{
    namespace Memory{
        ...
        void PageFrameAllocator_cl::ReadEfiMemoryMap(EFI_MEMORY_DESCRIPTOR* mMap,size_t mMapSize,size_t mDescriptorSize){
            Sauce::IO::Debug::Debugger_st Debugger("PageFrameAllocator_cl::ReadEfiMemoryMap",_NAMESPACE_);
        ...
        void PageFrameAllocator_cl::InitializeBitmap(size_t bitmapSize,void* bufferAddress){
            Sauce::IO::Debug::Debugger_st Debugger("PageFrameAllocator_cl::InitializeBitmap",_NAMESPACE_);
        ...
        void PageFrameAllocator_cl::FreePage(void* address){
            Sauce::IO::Debug::Debugger_st Debugger("PageFrameAllocator_cl::FreePage",_NAMESPACE_);
        ...
        void PageFrameAllocator_cl::LockPage(void* address){
            Sauce::IO::Debug::Debugger_st Debugger("PageFrameAllocator_cl::LockPage",_NAMESPACE_);
            uint64_t index = (uint64_t)address / 4096;
        ...
        void PageFrameAllocator_cl::ReleasePage(void* address){
            Sauce::IO::Debug::Debugger_st Debugger("PageFrameAllocator_cl::ReleasePage",_NAMESPACE_);
            uint64_t index = (uint64_t)address / 4096;
            if(PageBitmap[index] == false)return;
            if(PageBitmap.Set(index,false)){
                if(index < pageBitmapIndex)pageBitmapIndex=index;
        ...
        void PageFrameAllocator_cl::ReservePage(void* address){
            Sauce::IO::Debug::Debugger_st Debugger("PageFrameAllocator_cl::ReservePage",_NAMESPACE_);
            uint64_t index = (uint64_t)address / 4096;
            if(PageBitmap[index] == true)return;
            if(PageBitmap.Set(index,true)){
                freeMemory-=4096;
        ...
        void PageFrameAllocator_cl::FreePages(void* address,uint64_t pageCount){
            Sauce::IO::Debug::Debugger_st Debugger("PageFrameAllocator_cl::FreePages",_NAMESPACE_);
            for(size_t t=0;t<pageCount;t++){
                FreePage((void*)((uint64_t)address+(t*4096)));
            }
        }
        void PageFrameAllocator_cl::LockPages(void* address,uint64_t pageCount){
            Sauce::IO::Debug::Debugger_st Debugger("PageFrameAllocator_cl::LockPages",_NAMESPACE_);
            for(size_t t=0;t<pageCount;t++){
                LockPage((void*)((uint64_t)address+(t*4096)));
            }
        }
        void PageFrameAllocator_cl::ReservePages(void* address,uint64_t pageCount){
            Sauce::IO::Debug::Debugger_st Debugger("PageFrameAllocator_cl::ReservePages",_NAMESPACE_);
            for(size_t t=0;t<pageCount;t++){
                ReservePage((void*)((uint64_t)address+(t*4096)));
            }
        }
        void PageFrameAllocator_cl::ReleasePages(void* address,uint64_t pageCount){
            Sauce::IO::Debug::Debugger_st Debugger("PageFrameAllocator_cl::ReleasePages",_NAMESPACE_);
            for(size_t t=0;t<pageCount;t++){
                ReleasePage((void*)((uint64_t)address+(t*4096)));
            }
        }
        uint64_t PageFrameAllocator_cl::GetFreeRAM(){
            Sauce::IO::Debug::Debugger_st Debugger("PageFrameAllocator_cl::GetFreeRAM",_NAMESPACE_);
            return freeMemory;
        }
        uint64_t PageFrameAllocator_cl::GetUsedRAM(){
            Sauce::IO::Debug::Debugger_st Debugger("PageFrameAllocator_cl::GetUsedRAM",_NAMESPACE_);
            return usedMemory;
        }
        uint64_t PageFrameAllocator_cl::GetReservedRAM(){
            Sauce::IO::Debug::Debugger_st Debugger("PageFrameAllocator_cl::GetReservedRAM",_NAMESPACE_);
            return reservedMemory;
        }
        uint64_t PageFrameAllocator_cl::GetTotalRAM(){
            Sauce::IO::Debug::Debugger_st Debugger("PageFrameAllocator_cl::GetTotalRAM",_NAMESPACE_);
            size_t Ret = GetFreeRAM()+GetUsedRAM()+GetReservedRAM();
            return Ret;
        }
        void* PageFrameAllocator_cl::RequestPage(){
            Sauce::IO::Debug::Debugger_st Debugger("PageFrameAllocator_cl::RequestPage",_NAMESPACE_);
